-- Fix responsavel_email lookup in bulk_upsert_contatos to recognize
-- multi-tenant users (linked via user_empresas), not only profiles.empresa_id.
-- Applies the same predicate fix to both overloads (strict + non-strict).

-- =========================================================
-- Overload 1: non-strict (5 args)
-- =========================================================
        ...
        BEGIN
          ...
          WHERE (
                  ...
                  OR EXISTS (
                    ...
                    WHERE ue.user_id = p.id AND ue.empresa_id = p_empresa_id
                  )
                )

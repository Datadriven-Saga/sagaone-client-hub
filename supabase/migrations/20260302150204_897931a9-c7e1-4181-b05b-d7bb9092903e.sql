...
-- Update bulk_upsert_contatos to check the quarentena feature flag
...
BEGIN
  -- Check if quarantine feature is enabled
  ...
  LOOP
    BEGIN
      ...
      IF v_quarentena_enabled AND v_marca IS NOT NULL THEN
        SELECT 
          CASE 

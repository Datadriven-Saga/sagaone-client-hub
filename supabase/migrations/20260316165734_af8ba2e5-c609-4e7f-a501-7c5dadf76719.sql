...
-- 1. Add codigo_proposta column to contatos
ALTER TABLE public.contatos ADD COLUMN IF NOT EXISTS codigo_proposta text;

-- 2. Replace bulk_upsert_contatos to accept and persist codigo_proposta

-- =========================================================================
-- 1) Coluna bypass_compliance em empresas
-- =========================================================================
ALTER TABLE public.empresas
  ADD COLUMN IF NOT EXISTS bypass_compliance boolean NOT NULL DEFAULT false;

COMMENT ON COLUMN public.empresas.bypass_compliance IS
  'Empresa de uso interno (base de colaboradores). Quando true, ignora quarentena, opt-out externo, opt-out global e opt-out interno. Só deve ser ativada por Master.';

-- =========================================================================
-- 2) bulk_upsert_contatos com bypass por empresa
--    Mantém assinatura, SECURITY DEFINER, search_path. Sem overload.
-- =========================================================================

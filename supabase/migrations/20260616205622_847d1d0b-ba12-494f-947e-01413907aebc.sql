...
BEGIN
  ...
  IF v_uid IS NULL OR NOT public.user_can_access_empresa(v_job.empresa_id) THEN
...
GRANT EXECUTE ON FUNCTION public.cancel_scheduled_campaign_job(uuid) TO authenticated;

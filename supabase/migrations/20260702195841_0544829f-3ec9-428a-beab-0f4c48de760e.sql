...
BEGIN
  ...
  -- Bypass total para empresas de colaboradores: desliga quarentena nesta execução
  IF v_bypass THEN
  ...
  LOOP
    BEGIN
      ...
      -- Opt-out global: pulado quando empresa tem bypass
      ...
      -- =========================================================
      -- PASSO B: Sanitização de responsavel_email ANTES do INSERT.
      -- Evita gravar UUIDs, IDs numéricos do MySaga, typos de email
      -- ou textos aleatórios em contatos.responsavel_email.
      -- Se o identificador não corresponder a um usuário da empresa,
      -- a linha é inserida sem responsável (NULL) e contabilizada
      -- como skipped, com aviso em warning_details.
      -- Se corresponder, o valor é substituído pelo email canônico
      -- do usuário (evita variações de case ou UUID/celular).
      -- =========================================================
